"""Integration tests against a real Postgres built from `services/db/init`, as `lauretta_app`.
...
def seed(user: str) -> None:
    """A memory, a profile fact, a holding, a thesis, a thread and an alias for `user`, written
